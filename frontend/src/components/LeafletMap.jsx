...
// 메인 지도 이미지 경로
const mapImageUrl = `${API_BASE}/static/map/map.png`;
...
const backgroundMapImageUrl = `${API_BASE}/static/map/full_area_map.png`;
...
const partyIcon = L.icon({
  iconUrl: `${API_BASE}/static/icons/partyicon.png`, // 아이콘 이미지 경로
